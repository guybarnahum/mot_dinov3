Here you go! Drop these in your repo root.
...
# Data & outputs (keep placeholders if needed)
outputs/
data/*
!data/.gitkeep
...
# Videos & large media in repo root (avoid accidental commits)
*.mp4
*.mov
*.avi
*.mkv
...
> Tip: add empty placeholders if you want the folders tracked:
>
> ```
